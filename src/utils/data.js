    ...
    endpoints: [
      {
        ...
        url: `${API_BASE_URL}/api/get-linkedin-profile`,
        params: [],
        headers: [
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/bulk/get-linkedin-profile`,
        params: [],
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/find-key-person`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: {
          type: "None",
      ...
      },
      {
        ...
        method: "POST",
        name: "Find person",
        url: `${API_BASE_URL}/api/find-person`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: {
          type: "None",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/find-person-by-department`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: {
          type: "None",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/find-decision-makers`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: {
          type: "None",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/bulk/find-decision-makers`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: {
          type: "None",
    ...
    endpoints: [
      {
        ...
        url: `${API_BASE_URL}/api/amazing/person-cv`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/amazing/open-to-status`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/amazing/open-to-message`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
    ...
    endpoints: [
      {
        ...
        url: `${API_BASE_URL}/api/ai/linkedin-chat-bot`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/optimize-profile`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        method: "POST",
        name: "Magic Pen",
        url: `${API_BASE_URL}/api/ai/magic-pen`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/automated-recommendations`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/automated-insights`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/career-predict-progression`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/job-market-trends`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/message-email-crafter`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/profile-qualifier`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/bench-marking-tool`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/competitor-profile-analyser`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/lead-message-crafter`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/ai/ai-contact/{id}`,
        params: [
          {
            key: "id",
            value: "some-id",
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/bulk`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/id`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/domain`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/bulk/domain`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/deep`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/jobs`,
        params: [
          {
            key: "count",
            value: "10",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/posts`,
        params: [
          {
            key: "count",
            value: "10",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/post-comments`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/post-reposts`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/employeeCount`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/c-level-profiles`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ domain: "google.com" }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/coverImage`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/profileImage`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/company/followers`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
    ...
    endpoints: [
      {
        ...
        url: `${API_BASE_URL}/api/email-to-linkedin/bulk`,
        params: [
          {
            key: "count",
            value: "1",
      ...
      },
      {
        ...
        method: "POST",
        name: "Email to Linkedin",
        url: `${API_BASE_URL}/api/email-to-linkedin`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
    ...
    endpoints: [
      {
        ...
        url: `${API_BASE_URL}/api/geo-locations/{location}`,
        params: [
          {
            key: "location",
            value: "london",
    ...
    endpoints: [
      {
        ...
        url: `${API_BASE_URL}/api/job/details`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/job/search`,
        params: [
          {
            key: "count",
            value: "20",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/job/hiring-team`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ jobId: 4068479330 }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/job/hiring-team-email`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ jobId: 4068479330 }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/job/search-by-url`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
    ...
    endpoints: [
      {
        ...
        method: "POST",
        name: "Linkedin To Email",
        url: `${API_BASE_URL}/api/linkedin-to-email`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
  ...
  },
  {
    ...
    endpoints: [
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/bulk`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/urn`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/bulk/urn`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/deep`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/skills`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/education`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/experience`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/about`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/given-recommendations`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/received-recommendations`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/followers`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/connections`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/profile-picture`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/similar-profiles`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/posts`,
        params: [
          {
            key: "count",
            value: "20",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/post-comment`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/person/recent-activity`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
    ...
    endpoints: [
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/search-employee-profile`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/search-employee-result`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/search-company-profile`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ company: "apple.com" }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/search-company-result`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ company: "apple.com" }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/search-status`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/search-companies-with-url`,
        params: [
          {
            key: "count",
            value: "10",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/search-lead-with-url`,
        params: [
          {
            key: "count",
            value: "10",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/filters/company-head-count`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/filters/company-type`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/filters/seniority-type`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/filters/years`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/filters/languages`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/suggestions/function`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/suggestions/job-title`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ keyword: "binary" }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/suggestions/industry`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ keyword: "binary" }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/suggestions/geo-locations`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ keyword: "binary" }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/suggestions/company`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ keyword: "binary" }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/suggestions/search`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ keyword: "binary" }, null, 2),
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/sales-nav/suggestions/schools`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify({ keyword: "binary" }, null, 2),
    ...
    endpoints: [
      {
        ...
        url: `${API_BASE_URL}/api/search/posts-by-url`,
        params: [],
        headers: [{ key: "Content-Type", value: "application/json" }],
        auth: { type: "None", details: "This endpoint is open." },
        body: JSON.stringify(
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/posts`,
        params: [
          {
            key: "count",
            value: "20",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/persons`,
        params: [
          {
            key: "count",
            value: "20",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/companies`,
        params: [
          {
            key: "count",
            value: "20",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/schools`,
        params: [
          {
            key: "count",
            value: "20",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/suggestion/company-size`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/suggestion/language`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/suggestion/industry`,
        params: [
          {
            key: "keyword",
            value: "tech",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/suggestion/function`,
        params: [
          {
            key: "keyword",
            value: "eng",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/suggestion/service`,
        params: [
          {
            key: "keyword",
            value: "dev",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/suggestion/location`,
        params: [
          {
            key: "keyword",
            value: "lon",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/companies-with-filters`,
        params: [
          {
            key: "count",
            value: "20",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/search/persons-with-filters`,
        params: [
          {
            key: "count",
            value: "20",
    ...
    endpoints: [
      {
        ...
        url: `${API_BASE_URL}/api/mail-auth-tokens`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/mail-auth-tokens/reactivate/{email}`,
        params: [
          {
            key: "email",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/mail-auth-tokens/{email}`,
        params: [
          {
            key: "email",
            value: "user@example.com",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/linkedin-auth-tokens`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/linkedin-auth-tokens/reactivate/{email}`,
        params: [
          {
            key: "email",
            value: "user@example.com",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/linkedin-auth-tokens/{email}`,
        params: [
          {
            key: "email",
            value: "user@example.com",
      ...
      },
      {
        ...
        url: `${API_BASE_URL}/api/give-away-deals`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
      ...
      },
      {
        ...
        method: "POST",
        name: "Slack Notify",
        url: `${API_BASE_URL}/api/slack-notify`,
        params: [],
        headers: [],
        auth: { type: "None", details: "This endpoint is open." },
        body: null,
